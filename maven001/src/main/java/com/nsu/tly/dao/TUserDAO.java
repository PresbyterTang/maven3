...
public class TUserDAO {
	...
	private Session getCurrentSession() {
		...
		System.out.println("执行getCurrentSession方法");
	...
	public TUser findById(java.lang.Integer id) {
		...
		try {
			TUser instance = (TUser) getCurrentSession().get("com.nsu.tly.entity.TUser", id);
			return instance;
		} catch (RuntimeException re) {
	...
	public List findByExample(TUser instance) {
		...
		try {
			List results = getCurrentSession().createCriteria("com.nsu.tly.entity.TUser").add(Example.create(instance))
					.list();
